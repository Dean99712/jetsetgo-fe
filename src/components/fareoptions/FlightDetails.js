...
const FlightDetails = ({flightDetails, convertDate}) => {
    ...
    return (
        <div className="flightDetails">
            ...
            <div className="flight-details_title">
                <h5>Flight to {oic} <span className="flight-date">{getFullYearDate(segment[0].departing_at)}</span></h5>
            </div>
            ...
            <section className="flight-details_section">
                ...
                <div className="flight-details duration">
                    ...
                    <span></span><FontAwesomeIcon icon={faPlane}/>
