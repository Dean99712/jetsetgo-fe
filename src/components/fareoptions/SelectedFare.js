...
const SelectedFare = ({selected, navigateToCreateOrder, convertCurrency, fareDetails}) => {
    ...
    return (
        <div className="selected-fare_summary">
            ...
            <div className="fare-summary_bottom">
                ...
                <button disabled={!fare} onClick={() => navigateToCreateOrder(fare)} className="text-capitalize">go to
